import { z } from "zod";
import { ExecutionVersion } from "src/components/execution/InngestExecution.js";
...
export declare const stepsSchemas: {
    ...
    1: z.ZodDefault<z.ZodRecord<z.ZodString, z.ZodUnion<[z.ZodUnion<[z.ZodUnion<[z.ZodObject<{
        ...
        error: z.ZodType<import("src/types.js").JsonError, z.ZodTypeDef, import("src/types.js").JsonError>;
    }, "strict", z.ZodTypeAny, {
        error: {
