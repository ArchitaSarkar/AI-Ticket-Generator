...
import * as Temporal from "src/helpers/temporal.js";
import { type ExclusiveKeys, type ParametersExceptFirst, type SendEventPayload, type SimplifyDeep, type WithoutInternalStr } from "src/helpers/types.js";
import { type EventPayload, type HashedOp, type InvocationResult, type InvokeTargetFunctionDefinition, type SendEventOutput, type StepOptions, type StepOptionsOrId, type TriggerEventFromFunction, type TriggersFromClient } from "src/types.js";
import { type InngestExecution } from "src/components/execution/InngestExecution.js";
import { type ClientOptionsFromInngest, type GetEvents, type GetFunctionOutput, type GetStepTools, type Inngest } from "src/components/Inngest.js";
...
export declare const createStepTools: <TClient extends Inngest.Any>(client: TClient, execution: InngestExecution, stepHandler: StepHandler) => {
     ...
     */
    fetch: import("src/components/Fetch.js").StepFetch;
};
