...
import { type Jsonify } from "src/helpers/jsonify.js";
import { type AsArray, type IsNever, type SendEventPayload, type SimplifyDeep, type SingleOrArray, type WithoutInternal } from "src/helpers/types.js";
import { type Logger } from "src/middleware/logger.js";
import { type ClientOptions, type EventNameFromTrigger, type EventPayload, type FailureEventArgs, type Handler, type InvokeTargetFunctionDefinition, type SendEventOutput, type TriggersFromClient } from "src/types.js";
import { type EventSchemas } from "src/components/EventSchemas.js";
import { InngestFunction } from "src/components/InngestFunction.js";
import { type InngestFunctionReference } from "src/components/InngestFunctionReference.js";
import { InngestMiddleware, type ExtendWithMiddleware } from "src/components/InngestMiddleware.js";
/**
...
export declare const builtInMiddleware: [InngestMiddleware<{
    ...
    init({ client }: {
        ...
        onFunctionRun(arg: Readonly<{
            readonly steps: Readonly<import("src/types.js").IncomingOp>[];
            ...
            transformOutput({ result: { error } }: {
                result: Readonly<Pick<import("src/types.js").OutgoingOp, "error" | "data">>;
                step?: Readonly<Omit<import("src/types.js").OutgoingOp, "id">>;
            }): void;
