import { type RecursiveTuple, type StrictUnion } from "@inngest/agent-kit/node_modules/src/helpers/types.js";
import { type Cancellation, type ConcurrencyOption, type Handler, type TimeStr, type TimeStrBatch, type TriggersFromClient } from "@inngest/agent-kit/node_modules/src/types.js";
import { type GetEvents, type Inngest } from "@inngest/agent-kit/node_modules/src/components/Inngest.js";
import { type InngestMiddleware } from "@inngest/agent-kit/node_modules/src/components/InngestMiddleware.js";
import { ExecutionVersion, type IInngestExecution, type InngestExecutionOptions } from "@inngest/agent-kit/node_modules/src/components/execution/InngestExecution.js";
/**
