...
import { type ExclusiveKeys, type ParametersExceptFirst, type SendEventPayload, type SimplifyDeep, type WithoutInternalStr } from "@inngest/agent-kit/node_modules/src/helpers/types.js";
import { type EventPayload, type HashedOp, type InvocationResult, type InvokeTargetFunctionDefinition, type SendEventOutput, type StepOptions, type StepOptionsOrId, type TriggerEventFromFunction, type TriggersFromClient } from "@inngest/agent-kit/node_modules/src/types.js";
import { type ClientOptionsFromInngest, type GetEvents, type GetFunctionOutput, type Inngest } from "@inngest/agent-kit/node_modules/src/components/Inngest.js";
import { type InngestExecution } from "@inngest/agent-kit/node_modules/src/components/execution/InngestExecution.js";
...
export declare const createStepTools: <TClient extends Inngest.Any>(client: TClient, execution: InngestExecution, stepHandler: StepHandler) => {
    ...
    ai: {
        ...
        models: {
             ...
             * base URL.
             */
            gemini: AiAdapter.ModelCreator<[options: import("@inngest/ai").Gemini.AiModelOptions], import("@inngest/ai").Gemini.AiModel>;
        };
    };
    /**
