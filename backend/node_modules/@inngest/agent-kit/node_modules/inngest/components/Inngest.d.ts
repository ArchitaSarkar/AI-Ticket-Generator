import { type Jsonify } from "@inngest/agent-kit/node_modules/src/helpers/jsonify.js";
import { type AsArray, type IsNever, type SendEventPayload, type SimplifyDeep, type SingleOrArray, type WithoutInternal } from "@inngest/agent-kit/node_modules/src/helpers/types.js";
import { type Logger } from "@inngest/agent-kit/node_modules/src/middleware/logger.js";
import { type ClientOptions, type EventNameFromTrigger, type EventPayload, type FailureEventArgs, type Handler, type InvokeTargetFunctionDefinition, type SendEventOutput, type TriggersFromClient } from "@inngest/agent-kit/node_modules/src/types.js";
import { type EventSchemas } from "@inngest/agent-kit/node_modules/src/components/EventSchemas.js";
import { InngestFunction } from "@inngest/agent-kit/node_modules/src/components/InngestFunction.js";
import { type InngestFunctionReference } from "@inngest/agent-kit/node_modules/src/components/InngestFunctionReference.js";
import { InngestMiddleware, type ExtendWithMiddleware } from "@inngest/agent-kit/node_modules/src/components/InngestMiddleware.js";
/**
...
export declare const builtInMiddleware: [InngestMiddleware<{
    ...
    init({ client }: {
        ...
        onFunctionRun(arg: Readonly<{
            readonly steps: Readonly<import("@inngest/agent-kit/node_modules/src/types.js").IncomingOp>[];
            ...
            transformOutput({ result: { error } }: {
                result: Readonly<Pick<import("@inngest/agent-kit/node_modules/src/types.js").OutgoingOp, "error" | "data">>;
                step?: Readonly<Omit<import("@inngest/agent-kit/node_modules/src/types.js").OutgoingOp, "id">>;
            }): void;
